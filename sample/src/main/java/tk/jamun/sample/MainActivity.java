...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickMultiPagerBrowser(View view) {
    }

    public void onClickSinglePagerBrowser(View view) {
...
//                Log.d("jamun", currentUrl + "  " + eventId);
//            }
//        }).startActivity(this, "http://techcruzers.com");
    }
}
